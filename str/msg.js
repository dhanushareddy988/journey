...
var ASM_CONSTS = {
  1024: function() {const greetings="Hello from EM_ASM_INT!"; const bytecount=(Module.lengthBytesUTF8(greetings)+1); const greetingsPointer=Module._malloc(bytecount); Module.stringToUTF8(greetings,greetingsPointer,bytecount); return greetingsPointer;}
};
