...
// {{PRE_LIBRARY}}
  ...
  var __main_thread_futex_wait_address=5520;function _emscripten_futex_wake(addr, count) {
  ...
  function __cleanup_thread(pthread_ptr) {
      ...
      if (pthread) {
        ...
        var pthreadMainJs = locateFile('mutex.worker.js');
