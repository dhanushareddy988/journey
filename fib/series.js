...
var wasmBinaryFile = 'series.wasm';
...
function two_alerts(x){ var a=0,b=1; for(var i=0;i<x-2;i++){ $x=a+b; a=b; b=$x; } console.log('result ' + $x); }
...
var asmGlobalArg = {};
var asmLibraryArg = { "__handle_stack_overflow": ___handle_stack_overflow, "emscripten_get_sbrk_ptr": _emscripten_get_sbrk_ptr, "emscripten_resize_heap": _emscripten_resize_heap, "memory": wasmMemory, "table": wasmTable, "two_alerts": two_alerts };
var asm = createWasm();
Module["asm"] = asm;
/** @type {function(...*):?} */
...
/** @type {function(...*):?} */
var ___em_js__two_alerts = Module["___em_js__two_alerts"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["__em_js__two_alerts"].apply(null, arguments)
};
